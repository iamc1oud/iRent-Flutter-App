...
class ThemeProvider extends ChangeNotifier {
  ...
  ThemeData themeData() {
    return ThemeData(
      ...
      primaryColor: isLightTheme ? Colors.grey : Colors.white,
      ...
      floatingActionButtonTheme: isLightTheme
          ? FloatingActionButtonThemeData(backgroundColor: Colors.blue, foregroundColor: Colors.white)
          : FloatingActionButtonThemeData(backgroundColor: Colors.white, elevation: 5, foregroundColor: Colors.black),
